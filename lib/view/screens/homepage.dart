...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    getAllTasks();
    return ValueListenableBuilder(valueListenable: taskListnotifier, builder:(context,List <TaskModel> listOfTask,Widget ?child){
      ...
      return ListView.builder(
        ...
        return CustomTile(taskTitle: data.title, taskDescription: data.description,dateTime: data.dateTime,fordeletion: (){
          deleteFromDb(index);
